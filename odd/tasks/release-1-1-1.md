...
- [x] Merge the release commit, publish to npm, and verify the registry result.
...
- Published package: `@yoryoboy/arcamcp@1.1.1` with npm dist-tag `latest`.
- Release commit on `main`: `ad93a25`
